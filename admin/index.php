...
echo "
		...
		<div class='col-sm-6 col-md-6 col-lg-6 col-xl-3 '>
			<div class='container border inbox'>";

				foreach($connection->query("SELECT COUNT(messages) FROM message where sentTo_id = '".$_SESSION['username']."'") as $row) {  
				$count = $row['COUNT(messages)'] ;  
				}
echo "
				<div>
					<h3> $count </h3>
				...
				<a href = 'messages.php?ref=inbox&id=".$_SESSION['username']."' class='small-box-footer'>more info<i class='fa fa-arrow-circle-right'></i></a>
				<div class='icon'>
		...
		<div class='col-sm-6 col-md-6 col-lg-6 col-xl-3 '>
			<div class='container border email'>
";
				foreach($connection->query("SELECT COUNT(email) FROM email") as $row) {  
